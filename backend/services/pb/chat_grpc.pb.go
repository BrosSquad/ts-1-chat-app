...
func (x *chatConnectClient) Recv() (*MessageResponse, error) {
...
func (UnimplementedChatServer) SendMessage(context.Context, *MessageRequest) (*Empty, error) {
...
func (x *chatConnectServer) Send(m *MessageResponse) error {
